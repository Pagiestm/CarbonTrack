            ...
            <nav>
                <ul>
                    <router-link to="/" @click="closeMenu"
                        class="flex items-center p-4 hover:bg-gray-200 transition-all duration-200">
                        <li class="flex items-center">
                            <svg class="mr-3" xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960"
                                width="30px">
                                <path
